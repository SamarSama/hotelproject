...
class _CustomerDataState extends State<CustomerData> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Selector<CustomerDataProvider,bool>(
        selector: (p0, p1) => p1.isLoading,
        builder: (context, isLoading, child) =>  IndexedStack(
          index: isLoading?1:0,
          children: [
            ListView(
            ...
            Container(width: double.infinity,
              height: double.infinity,child: Center(child: CircularProgressIndicator(color: Colors.green,)),)
          ],
        ),
      ...
      drawer: SafeArea(
        child: Drawer(
          ...
          child: ListView(
            // header
            children: [
              Selector<CustomerDataProvider,ProfileModelRespose?>(
                selector: (p0, p1) => p1.ProfileModel,
                builder: (context, ProfileModel, child) => DrawerHeader(
